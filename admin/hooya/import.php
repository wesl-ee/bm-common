...
include CONFIG_ROOT_PATH."/includes/access.php";
include CONFIG_ROOT_PATH."/bmfft/bmfft_db.php";
// Don't let not-admins in here!
if (!db_isAdmin($_SESSION['user_id'])) die;
...
<div id="right_frame">
	...
	<form method="POST" style="display:block;width:70%;margin:auto;">
		<input type="text" name="key" placeholder="file key or path" style="width:100%;margin-top:10px;"></input>
